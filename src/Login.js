      ...
      <div class="text-center p-14 max-w-[40vh] min-w-[40vh] min-h-[45vh] max-h-[45vh] rounded-lg border border-gray-200 shadow-lg bg-gray-800 border-gray-600">
        <form class="flex flex-col space-y-12 pt-2" action="#">
            <div>
                ...
                <input onChange={(e) => setEmail(e.target.value)} type="email" name="email" id="email" class="border border-gray-300 text-gray-900 text-2xl rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-600 border-gray-500 placeholder-gray-400 text-white" placeholder="name@placeholder.com" required />
            </div>
            <div className="pb-24">
                <label for="password" class="block mb-2 text-2xl font-medium text-gray-300">Your password</label>
                <input onChange={(e) => setPassword(e.target.value)} type="password" name="password" id="password" placeholder="••••••••" class=" border border-gray-300 text-gray-900 text-2xl rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-600 border-gray-500 placeholder-gray-400 text-white" required />
            </div>
