const Successful = ({message, handleClose}) => {
  return (
  <div id="toast-success" className="flex items-center w-full max-w-[50%] p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
...
const Wrong = ({message, handleClose}) => {
  return (
  <div id="toast-warning" className="flex items-center w-full max-w-[50%] p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
