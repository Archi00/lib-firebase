  ...
  return (
      ...
      <div className="text-center px-14 py-6 max-w-[40vh] min-w-[40vh] min-h-[50vh] max-h-[50vh] bg-white rounded-lg border border-gray-200 shadow-lg dark:bg-gray-800 dark:border-gray-600">
        <form className="flex flex-col space-y-4" action="">
            ...
            <div>
                <label htmlFor="password" className="block mb-2 text-2xl font-medium text-gray-900 dark:text-gray-300">Your password</label>
            ...
            <div className="pb-20">
                <label htmlFor="password" className="block mb-2 text-2xl font-medium text-gray-900 dark:text-gray-300">Confirm your password</label>
